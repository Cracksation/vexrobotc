...
#pragma config(Motor,  port1,           conveyor,      tmotorVex393HighSpeed, openLoop)
...
task main ()
{
	...
	while(1 == 1)
	{
		...
		//if(armDownLimitReached == true && ((motor[armRight1] < 0) || (motor[armLeft1] < 0) || (motor[armRight2] < 0) || (motor[armLeft2] < 0)))
		...
		//else if(armUpLimitReached == true && ((motor[armRight1] > 0) || (motor[armRight2] > 0) || (motor[armLeft1] > 0) || (motor[armLeft2] > 0)))
		...
		else if (armDownCommand == true )
		{
			if(SensorValue[armRight] > SensorValue[armLeft])
			{
				motor[armLeft1] = -armSpeedSlow/4;
				motor[armLeft2] = -armSpeedSlow/4;
				motor[armRight1] = -armSpeedFast/4;
				motor[armRight2] = -armSpeedFast/4;
			}
			else if( SensorValue[armLeft] > SensorValue[armRight])
			{
				motor[armLeft1] = -armSpeedFast/4;
				motor[armLeft2] = -armSpeedFast/4;
				motor[armRight1] = -armSpeedSlow/4;
				motor[armRight2] = -armSpeedSlow/4;
			}
			else
			{
				motor[armLeft1] = -armSpeedNormal/4;
				motor[armLeft2] = -armSpeedNormal/4;
				motor[armRight1] = -armSpeedNormal/4;
				motor[armRight2] = -armSpeedNormal/4;
			}
		}
