...
static const word armBuckyDumpPositionValue     = 70;
static const word armBigBallPositionValue       = 40;
...
//----------------------------------------------------------------------------------------------------*/
word getArmCommandValue( word setpoint, word armPosition )
{
...
void controlArmToPosition( word setpoint )
{
    ...
    commandValueRight = getArmCommandValue( setpoint, SensorValue[armEnc_right] );
    commandValueLeft  = getArmCommandValue( setpoint, SensorValue[armEnc_left] );
