...
#pragma config(Motor,  port7,           armRight,      tmotorServoContinuousRotation, openLoop, encoder, encoderPort, dgtl7, 1000)
#pragma config(Motor,  port8,           armLeft,       tmotorServoStandard, openLoop, reversed)
#pragma config(Motor,  port9,           armLeft,       tmotorServoStandard, openLoop, reversed)
